//ETO HEAD FILE DLYA SOZDANIYA GRAFICA V MSVS. ON ZDES PROSTO CHTOBI NE POTERIAT, TK NE PULUCHILOS SKACHAT QT IZZA OGRANICHENII I ZAPRETA SKACHIVANIYA NA TERRITORII RB(KONFLICT ROSSII-UKRAINI)
#pragma once
